...
void ImageSegmentor::exeSegment()
{
    ...
    else
    {
        ...
        //waitKey(2000);
        imwrite("F:\\Image-Processing-main\\image-processing-segmentation\\binary_segmentation\\OutputImage\\GrayImage.jpg", img_gray);
        ...
        //waitKey(2000);
        imwrite("F:\\Image-Processing-main\\image-processing-segmentation\\binary_segmentation\\OutputImage\\BanlancedImage.jpg", img_eh);
        double thresh = 128;
        Mat img_seg;
        img_seg = BasicSegment(img_eh, thresh);
        theResult = img_seg;
        imwrite("F:\\Image-Processing-main\\image-processing-segmentation\\binary_segmentation\\OutputImage\\BasicSegment.jpg", img_seg);
        img_seg = OtsuSegment(img_eh);
        imwrite("OutputImage\\OtsuSegment.jpg", img_seg);
        img_seg = MaxEntropySegment(img_eh);

        imwrite("F:\\Image-Processing-main\\image-processing-segmentation\\binary_segmentation\\OutputImage\\MaxEntropySegment.jpg", img_seg);
        img_seg = KmeansSegment(img_eh);
        imwrite("F:\\Image-Processing-main\\image-processing-segmentation\\binary_segmentation\\OutputImageOutputImage\\KmeansSegment.jpg", img_seg);
        Point initial_point = Point(128, 128);
        int growthresh = 17;
        img_seg = RegionGrowSegment(img_eh, initial_point, growthresh);
        imwrite("F:\\Image-Processing-main\\image-processing-segmentation\\binary_segmentation\\OutputImageOutputImage\\RegionGrowSegment.jpg", img_seg);
        img_seg = NewMethodSegment(img_eh);
        imwrite("F:\\Image-Processing-main\\image-processing-segmentation\\binary_segmentation\\OutputImageOutputImage\\NewMethodSegment.jpg", img_seg);
    }
}
